...
INSERT INTO CONTENT (title, description, release_year, duration, content_type, total_seasons, thumbnail_url, video_url, rating, director)
    ...
    ('Money Heist', 'Criminals plan the perfect heist on the Spanish Royal Mint.', 2017, 45, 'TV Show', 5, 'https://m.media-amazon.com/images/I/81WSF164GOL._AC_UF1000,1000_QL80_.jpg', 'https://youtu.be/futT5F-qx_A?si=EMbQ_jopcuWm6tDs', 8.3, '╬ô├╢┬úΓö£Γò¥lex Pina'),
    ...
    ('Bohemian Rhapsody', 'A biographical film about QueenΓò¼├┤Γö£├ºΓö£├╗s lead singer Freddie Mercury.', 2018, 134, 'Movie', 0, 'https://m.media-amazon.com/images/M/MV5BMTA2NDc3Njg5NDVeQTJeQWpwZ15BbWU4MDc1NDcxNTUz._V1_.jpg', 'https://youtu.be/WdyFrGMfEkk?si=tvbvDWc06yjJVY2b', 8.0, 'Bryan Singer');
